...
\begin{figure}[t!]
    ...
    \caption{\small Illustration of two interacting qubits in contact wit a global bath. The red qubit is at a colder temperature $T_c$ and will heat up to the bath's temperature $T_w$. The blue qubit is at a hotter temperature $T_h$ and will cool down to the bath's temperature $T_w$. The qubits can interact with a strength $J$.}
     \vspace{0.1cm}
...
\begin{figure}[t]
    ...
    \caption{\small Degree of completion for XX-model. Each line correspond to cooling (blue) or heating (red) processes with (solid) or without (dashed) interaction between qubits.}
     \vspace{0.1cm}
    {\small Source: By the author}
...
\begin{figure}[t]
    ...
    \caption{\small Statistical velocity for XX-model. Each line correspond to cooling (blue) or heating (red) processes with (solid) or without (dashed) interaction between qubits.}
     \vspace{0.1cm}
    {\small Source: By the author}
