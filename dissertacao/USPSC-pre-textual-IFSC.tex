...
\titulo{Exploration of Thermal Relaxation Asymmetry in the Quantum Regime}
...
\titleabstract{Exploration of Thermal Relaxation Asymmetry in the Quantum Regime}
\tituloresumo{Exploration of Thermal Relaxation Asymmetry in the Quantum Regime}
\autor{Camila Raupp da Luz}
\autorficha{RAUPP, Camila}
\autorabr{RAUPP, C.}
...
\orientador{Dr. Ivan Medina}
%\orientadorcorpoficha{orientador Ivan Medina}
%\orientadorficha{MEDINA, Ivan, orient}
...
\coorientador{Prof. Dr. Diogo O. Soares-Pinto}
\orientadorcorpoficha{orientador Ivan Medina ;  co-orientador Diogo O. Soares-Pinto}
\orientadorficha{MEDINA, Ivan, orient. II. Soares-Pinto, DO, co-orient}
