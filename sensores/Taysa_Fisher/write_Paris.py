...
#######  Ancilla 3
 ...
 #######  Ancilla 4   
    ...
    psi = tensor(A1_st,A2_st,A3_st,A4_st) # vetor
...
Write_Outfile(ddTemp, QFIA1[:,-1], f'./Results/k4QFI_q1_g{g:.1f}_ttherm{tSEmax:.3f}.txt')
Write_Outfile(ddTemp, QFIA2[:,-1], f'./Results/k4QFI_q2_g{g:.1f}_ttherm{tSEmax:.3f}.txt')
Write_Outfile(ddTemp, QFIA3[:,-1], f'./Results/k4QFI_q3_g{g:.1f}_ttherm{tSEmax:.3f}.txt')
Write_Outfile(ddTemp, QFIA4[:,-1], f'./Results/k4QFI_q4_g{g:.1f}_ttherm{tSEmax:.3f}.txt')
