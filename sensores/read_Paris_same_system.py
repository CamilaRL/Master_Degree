...
temp1, QFI_q1 = np.loadtxt(f'./Results/QFI_q1_g{g:.1f}_ttherm{tSEmax:.3f}.txt', unpack=True)
temp2, QFI_q2 = np.loadtxt(f'./Results/QFI_q2_g{g:.1f}_ttherm{tSEmax:.3f}.txt', unpack=True)
temp3, QFI_q3 = np.loadtxt(f'./Results/QFI_q3_g{g:.1f}_ttherm{tSEmax:.3f}.txt', unpack=True)
temp4, QFI_q4 = np.loadtxt(f'./Results/QFI_q4_g{g:.1f}_ttherm{tSEmax:.3f}.txt', unpack=True)
