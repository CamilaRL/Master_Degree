...
#os.mkdir(f'./FisherInformation_J{J}_delta{delta}')
os.mkdir(f'./FisherInformation_J{J}_delta{delta}/{modo}')
...
for g in gList:
    ...
    tempo_index, rhof_q_min = Read_Density_Matrices(f'./DensityMatrices_J{J}_delta{delta}/rhof_{qubit}_cmin_g{g}.txt', 2)
    tempo_index, rhof_q_max = Read_Density_Matrices(f'./DensityMatrices_J{J}_delta{delta}/rhof_{qubit}_cmax_g{g}.txt', 2)
    ...
    fmin = open(f'./FisherInformation_J{J}_delta{delta}/{modo}/QFI_{qubit}_cmin_g{g}.txt', 'w')
    fmax = open(f'./FisherInformation_J{J}_delta{delta}/{modo}/QFI_{qubit}_cmax_g{g}.txt', 'w')
