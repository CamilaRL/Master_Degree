...
plt.plot(tempo_real, temp_q1[1], color='red', linewidth=2, label='J = 1.6 - Heating')
plt.plot(tempo_real, temp_q2[1], color='blue', linewidth=2, label='J = 1.6 - Cooling')
...
plt.plot(tempo_real, temp_q1[3], color='red', linewidth=2, label='J = 1.6 - Heating')
plt.plot(tempo_real, temp_q2[3], color='blue', linewidth=2, label='J = 1.6 - Cooling')
