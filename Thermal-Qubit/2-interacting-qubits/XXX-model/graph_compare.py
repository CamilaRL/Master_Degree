...
for i in range(len(cList)):
    ...
    plt.plot(tlist_a0, completion_a0, color='red', linestyle='--', linewidth=2, label=f'J = {glist[0]} - Heating')
    plt.plot(tlist_r0, completion_r0, color='blue', linestyle='--', linewidth=2, label=f'J = {glist[0]} - Cooling')
    
    plt.plot(tlist_a1, completion_a1, color='red', linewidth=2, label=f'J = {glist[1]} - Heating')
    plt.plot(tlist_r1, completion_r1, color='blue', linewidth=2, label=f'J = {glist[1]} - Cooling')
    ...
    plt.plot(tlist_a0, velocidade_a0, color='red', linestyle='--', linewidth=2, label=f'J = {glist[0]} - Heating')
    plt.plot(tlist_r0, velocidade_r0, color='blue', linestyle='--', linewidth=2, label=f'J = {glist[0]} - Cooling')
    
    plt.plot(tlist_a1, velocidade_a1, color='red', linewidth=2, label=f'J = {glist[1]} - Heating')
    plt.plot(tlist_r1, velocidade_r1, color='blue', linewidth=2, label=f'J = {glist[1]} - Cooling')
    ...
    plt.plot(t_sigma_a0, sigma_a0, color='red', linestyle='--', linewidth=2, label=f'J = {glist[0]} - Heating')
    plt.plot(t_sigma_r0, sigma_r0, color='blue', linestyle='--', linewidth=2, label=f'J = {glist[0]} - Cooling')
    
    plt.plot(t_sigma_am, sigma_am, color='red', linewidth=2, label=f'J = {glist[1]} - Heating')
    plt.plot(t_sigma_rm, sigma_rm, color='blue', linewidth=2, label=f'J = {glist[1]} - Cooling')
